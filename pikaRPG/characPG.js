...
$(".char").on('click', begin); $("#attackBtn").prop("disabled", true); $("#btnChangePly1").hide(); $("#btnChangePly2").hide(); $("#restartBtn").hide();
// $("#btnChangePly1").css('display', 'none');
// $("#btnChangePly2").css('display', 'none');
$("#btnChangePly1").on('click', btnHandlers.changePlayer1); $("#btnChangePly2").on('click', btnHandlers.changePlayer2); $("#restartBtn").on('click', btnHandlers.restart);
console.log(pokeBg)
